 ...
 */
public class FollowingFeedTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_following_feed_tab, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final SwipeRefreshLayout swipeRefreshLayout = getView().findViewById(R.id.swipe_container_FollowingFeed_fragment);
    ...
    private void StartOrReload() {
        ...
        final RecyclerView GeneralFeed = getView().findViewById(R.id.rvFollowingFeedFragment);
