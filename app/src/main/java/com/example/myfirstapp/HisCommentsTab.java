...
public class HisCommentsTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_his_comments_tab, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final SwipeRefreshLayout swipeRefreshLayout = getView().findViewById(R.id.swipe_container_HisComments_fragment);
    ...
    private void StartOrReload() {
        ...
        final RecyclerView CommentView = getView().findViewById(R.id.rvHisCommentsFragment);
        ...
        final ProgressBar progressBar = getView().findViewById(R.id.pbLoadingHisComments_fragment);
