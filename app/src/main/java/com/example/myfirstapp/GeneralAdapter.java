...
public class GeneralAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ImagePostViewHolder){
            ((ImagePostViewHolder) holder).bind((ImagePost), item);
        }else {
...
//y
   ...
   private static class TextPostViewHolder extends RecyclerView.ViewHolder{
       ...
       public ImageButton Upvote, Downvote, DeleteTextPost;
        ...
        public void bind(TextPost textPost){
            PostStuffForText uploadCurrent = mList.get(position);
    ...
    private static class ImagePostViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(ImagePost imagePost){
            final PostStuffForText uploadCurrent = mList.get(position);
